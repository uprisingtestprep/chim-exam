/* CHIM Exam Simulator, Application Logic */

const ACCESS_CODE  = "CHIM9000";
const EXAM_SECONDS = 12600;
const PASSING_PCT  = 60;
const STORAGE_KEY  = "chim_exam_state_v1";
const SIM_Q_COUNT  = 154;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"biomedical_sciences": "Biomedical Sciences", "health_information_science_and_coding_theory": "Health Information Science and Coding Theory", "health_information_analysis": "Health Information Analysis", "technology_and_health_information": "Technology and Health Information", "access_and_security": "Access and Security", "the_health_care_system_in_canada": "The Health Care System in Canada", "ethics_and_practice": "Ethics and Practice"};  // maps domain key -> human-readable label for display
